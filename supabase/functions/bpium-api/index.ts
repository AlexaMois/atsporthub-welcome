      ...
      const aiRes = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'Ты профессиональный ассистент в транспортной компании. Твоя задача — прочитать текст документа и составить краткое саммари (3-5 предложений). Пиши четко, на русском языке. Укажи: 1) О чем документ. 2) Кому он важен. 3) Ключевое требование. Пиши коротко, простым языком, как для сотрудника без юридического образования. Максимум 5-6 предложения.'
            },
            {
              role: 'user',
